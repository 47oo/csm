...
> 本目录保存 CSM V2 已批准的架构决策。状态：`PROPOSED` / `ACCEPTED` / `SUPERSEDED`。
> 权威领域与产品事实仍在 `docs/product/`；项目状态以 `docs/project/project-plan.yaml` 为准。

| ADR | 决策 ID | 主题 | 状态 | 批准 |
| --- | --- | --- | --- | --- |
| [ADR-001](adr-001-technology-stack.md) | D-ARCH-STACK | 技术栈与运行时 | ACCEPTED | 2026-09-25（用户，revision 8 / BQ-V） |
